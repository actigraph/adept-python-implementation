...
class TestSegmentPatternSuite1(unittest.TestCase):

    def test_suite_1_example_a(self):
        """
        CASE:
        - no noise in signal
        ...
        exp = [1, 100, 200, 300, 400, 500, 600, 700, 800, 900]
    ...
    def test_suite_1_example_b(self):
        """
        CASE:
        - no noise in signal
        - all pattern occurences of the same length (vector length: 101)
    ...
    def test_suite_1_example_c(self):
        """
        CASE:
        - no noise in signal
        - all pattern occurences of the same length (vector length: 101)
...
class TestSegmentPatternSuite2(unittest.TestCase):

    def test_suite_2_example_a(self):
        """
        CASE:
        - no noise in signal
    ...
    def test_suite_2_example_b(self):
        """
        CASE:
        - no noise in signal
        - pattern occurences of different length
    ...
    def test_suite_2_example_c(self):
        """
        CASE:
        - no noise in signal
...
if __name__ == '__main__':
    ## If ran from notebook - reference:
